...
- Sharing: one simple Share Game button using the device/browser share sheet
...
- The Share Game button uses built-in browser/device sharing when available; no social app account data is received by the game
